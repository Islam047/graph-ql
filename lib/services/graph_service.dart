...
query{
  ...
  // Mutation
  static String mutationMessageSendOrUpdate(bool isUpdate) {
    if(!isUpdate){
      return """
...
return """
mutation toggleTodo(\$message: String!,\$id: Int ) {
  update_messages(where: {id: {_eq: \$id}}, _set: {message: \$message}) {
    returning {
      message
    }
  }
...
;
  ...
  static String mutationMessageDelete() {
    return """
...
subscription {
  ...
  static Map<String, dynamic> variableUpdateMessage(String message,int id) {
    return {
  ...
  static Map<String, dynamic> variableDeleteMessage(int id) {
    return {
      "id": id,
    };
  }
